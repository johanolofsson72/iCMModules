...
#Region " Timeline Functions "
    ...
    Private Function GetTimelineAppointments(ByVal SelectedDate As Date, ByVal Span As Integer) As DataSet
        ...
        Try
            ...
            If Not oDO.GetDataSet("cal_calendar", "sit_id = " & oSite.SiteId & " AND pag_id = " & oSite.ActivePage.PageId & " AND mod_id = " & iModId & " AND cal_endtime <= ' " & sEndDate & " ' AND cal_endtime >= ' " & sStartDate & " ' AND cal_hidden = 0 AND cal_deleted = 0", "cal_allday, cal_starttime", "", ED, EC, ds) Then
