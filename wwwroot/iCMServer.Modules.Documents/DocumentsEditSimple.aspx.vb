Public Class DocumentsEditSimple
...
#End Region
    ...
    Private Sub BindData()
        ...
        If Not DocId = 0 Then
            ...
            If Not Page.IsPostBack Then
                ...
                ds = oDoc.GetDocumentInfoSimple(ModId, DocId)
    ...
    Private Sub btnUpdate_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnUpdate.Click
        If Not (FileUpload.PostedFile Is Nothing) Then
            If FileUpload.PostedFile.ContentLength < MaxPostedFileLength Then
                ...
                m_DocId = oDoc.CheckIfFileAlreadyExistsSimple(PagId, ModId, txtTitle.Text)
                If Not m_DocId = 0 Then
                    ' Automaticaly save a new revision...
                    If Not oDoc.UpdateDocumentSimple(ModId, m_DocId, Context.User.Identity.Name, txtTitle.Text, content, contentType, length, 0, 0) Then
                        Response.Write("<script>alert('" & Replace(Err.Description, "'", "") & "');</script>") : Response.End()
                    End If
                Else
                    If NewRevision Then
                        ' Save a new revision...
                        If Not oDoc.UpdateDocumentSimple(ModId, DocId, Context.User.Identity.Name, txtTitle.Text, content, contentType, length, 0, 0) Then
                            Response.Write("<script>alert('" & Replace(Err.Description, "'", "") & "');</script>") : Response.End()
                        End If
                    Else
                        ' Save a fresh file...
                        If Not oDoc.AddDocumentSimple(PagId, ModId, Context.User.Identity.Name, txtTitle.Text, content, contentType, length, 1, 0) Then
                            Response.Write("<script>alert('" & Replace(Err.Description, "'", "") & "');</script>") : Response.End()
                        End If
                    End If
                End If
    ...
    Private Sub btnDelete_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnDelete.Click
        Dim oDoc As New clsDocuments
        If Not oDoc.DeleteDocumentSimple(ModId, DocId) Then
    ...
    Private Sub btnRevision_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnRevision.Click
        Dim oDoc As New clsDocuments
        Revisions.Controls.Add(New System.Web.UI.LiteralControl(oDoc.GetDocumentRevisionsSimple(ModId, DocId)))
    End Sub
