...
Public Class clsTemplate005
    ...
    Public Function GetTemplate() As DataSet
        Try
            ...
            If Not oDO.GetDataSet("tem_template005", "sit_id = " & oSite.SiteId & " AND pag_id = " & Me.PagId & " AND mod_id = " & Me.ModId & " AND tem_hidden = 0 AND tem_deleted = 0", "", "", ED, EC, ds) Then
    ...
    Public Function UpdateTemplate(ByVal Header1 As String, ByVal Ingress1 As String, ByVal Text1 As String, ByVal Header2 As String, ByVal Text2 As String, ByVal Header3 As String, ByVal Text3 As String) As Boolean
        Try
            ...
            If Not Exists Then
                ds = New DataSet
                If Not oDO.GetEmptyDataSet("tem_template005", "", ED, EC, ds) Then
                    Return False
                End If
                With ds.Tables(0).Rows(0)
                    ...
                    .Item("tem_ingress1") = Ingress1
                    .Item("tem_text1") = Text1
                    .Item("tem_header2") = Header2
                    .Item("tem_text2") = Text2
                    .Item("tem_header3") = Header3
                    .Item("tem_text3") = Text3
