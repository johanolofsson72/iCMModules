...
Public Class Template005 : Inherits clsSiteModuleControl
...
#Region " Web Form Designer Generated Code "
    ...
    Protected WithEvents Text2 As System.Web.UI.WebControls.Label
    Protected WithEvents Header3 As System.Web.UI.WebControls.Label
    Protected WithEvents Text3 As System.Web.UI.WebControls.Label
    Protected WithEvents Ingress1 As System.Web.UI.WebControls.Label
...
#End Region
    ...
    Private Sub BindData()
        Try
            ...
            Dim oTemplate005 As New clsTemplate005(ModuleId, oSite.ActivePage.PageId, clsSiteSecurity.HasEditPermissions(ModuleId))
            ...
            Try
                ...
                Dim Bmp As New System.Drawing.Bitmap(System.Web.HttpContext.Current.Server.MapPath("./Desktop/Modules/Template005/BinaryFileCache/" & "Template005_1__" & ModuleId.ToString & ".png"))
                ...
                Image1.ImageUrl = "BinaryFileCache/" & "Template005_1__" & ModuleId.ToString & ".png"
                Image1.Visible = True
            ...
            Try
                ...
                Dim Bmp As New System.Drawing.Bitmap(System.Web.HttpContext.Current.Server.MapPath("./Desktop/Modules/Template005/BinaryFileCache/" & "Template005_2__" & ModuleId.ToString & ".png"))
                Dim oThumb As New iConsulting.Library.Image.clsThumbnail(Height, Width, Bmp)
                Image2.Height = Unit.Pixel(oThumb.GetThumbHeight)
                Image2.Width = Unit.Pixel(oThumb.GetThumbWidth)
                Image2.ImageUrl = "BinaryFileCache/" & "Template005_2__" & ModuleId.ToString & ".png"
                Image2.Visible = True
            Catch ex As Exception
            ...
            Try
                Dim Height As Integer = "190"
                Dim Width As Integer = "190"
                Dim Bmp As New System.Drawing.Bitmap(System.Web.HttpContext.Current.Server.MapPath("./Desktop/Modules/Template005/BinaryFileCache/" & "Template005_3__" & ModuleId.ToString & ".png"))
                Dim oThumb As New iConsulting.Library.Image.clsThumbnail(Height, Width, Bmp)
                Image3.Height = Unit.Pixel(oThumb.GetThumbHeight)
                Image3.Width = Unit.Pixel(oThumb.GetThumbWidth)
                Image3.ImageUrl = "BinaryFileCache/" & "Template005_3__" & ModuleId.ToString & ".png"
                Image3.Visible = True
            Catch ex As Exception
