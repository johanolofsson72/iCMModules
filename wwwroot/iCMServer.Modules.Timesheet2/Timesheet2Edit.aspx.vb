...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        al = oLanguageText.GetLanguageTextByLocation(oSite.Language, "iConsulting.iCMServer.Modules.Timesheet2")
        ...
        HeaderText.Text = Server.HtmlDecode(oLanguageText.Find(al, "timesheet2_header"))
        SubText2.Text = Server.HtmlDecode(oLanguageText.Find(al, "timesheet2_users"))
        SubText3.Text = Server.HtmlDecode(oLanguageText.Find(al, "timesheet2_addedusers"))
    ...
    Private Sub FixStyles()
        btnDelete.Text = Server.HtmlDecode(oLanguageText.Find(al, "timesheet2_delete"))
        btnDelete.CssClass = "iCWebControlsII"
        btnAdd.Text = Server.HtmlDecode(oLanguageText.Find(al, "timesheet2_add"))
        btnAdd.CssClass = "iCWebControlsII"
        btnOk.Text = Server.HtmlDecode(oLanguageText.Find(al, "timesheet2_ok"))
        btnOk.CssClass = "iCWebControlsII"
        btnCancel.Text = Server.HtmlDecode(oLanguageText.Find(al, "timesheet2_cancel"))
    ...
    Private Sub btnAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAdd.Click
        ...
        Dim oTimesheet2 As New clsTimesheet2(ModId)
        If Not oTimesheet2.UpdateModuleUsers(oSite.ActivePage.PageId, ModId, Users) Then
