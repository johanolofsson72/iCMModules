...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        al = oLanguageText.GetLanguageTextByLocation(oSite.Language, "iConsulting.iCMServer.Modules.Timesheet3")
        ...
        HeaderText.Text = Server.HtmlDecode(oLanguageText.Find(al, "timesheet3_header"))
        SubText2.Text = Server.HtmlDecode(oLanguageText.Find(al, "timesheet3_users"))
        SubText3.Text = Server.HtmlDecode(oLanguageText.Find(al, "timesheet3_addedusers"))
    ...
    Private Sub FixStyles()
        btnDelete.Text = Server.HtmlDecode(oLanguageText.Find(al, "timesheet3_delete"))
        btnDelete.CssClass = "iCWebControlsII"
        btnAdd.Text = Server.HtmlDecode(oLanguageText.Find(al, "timesheet3_add"))
        btnAdd.CssClass = "iCWebControlsII"
        btnOk.Text = Server.HtmlDecode(oLanguageText.Find(al, "timesheet3_ok"))
        btnOk.CssClass = "iCWebControlsII"
        btnCancel.Text = Server.HtmlDecode(oLanguageText.Find(al, "timesheet3_cancel"))
    ...
    Private Sub btnAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAdd.Click
        ...
        Dim oTimesheet3 As New clsTimesheet3(ModId)
        If Not oTimesheet3.UpdateModuleUsers3(oSite.ActivePage.PageId, ModId, Users) Then
