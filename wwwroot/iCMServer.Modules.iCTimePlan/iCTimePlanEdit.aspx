...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="iCTimePlanEdit.aspx.vb" Inherits="iConsulting.iCMServer.Modules.iCTimePlan.iCTimePlanEdit" %>
									...
									<table cellSpacing="1" cellPadding="2" border="0">
										...
										<tr>
											...
											<td colSpan="2" align="right">
												<asp:Button id="btnAdd" runat="server" Text="Add" DESIGNTIMEDRAGDROP="92" CssClass="button"></asp:Button></td>
										</tr>
										<tr>
											...
											<td colSpan="2" vAlign="bottom" align="right">
												<asp:Button id="btnDelete" runat="server" Text="Delete" CssClass="button"></asp:Button>
											</td>
										</tr>
										<tr>
											<td colSpan="4">
