...
#End Region
    ...
    Private Sub btnUpdate_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnUpdate.Click
        ...
        Dim oTime As New clsiCTimePlan(ModId)
        Dim id As String
        Dim startTimeAm As String
        Dim breakTimeAm As String
        Dim endTimeAm As String

        id = Split(Request("ddlTripCode"), ";")(0)
        startTimeAm = Split(Request("ddlTripCode"), ";")(1)
        breakTimeAm = Split(Request("ddlTripCode"), ";")(2)
        endTimeAm = Split(Request("ddlTripCode"), ";")(3)

        oTime.SaveTripCode(ddlTripCode.SelectedItem.Text, SelectedDate, startTimeAm, breakTimeAm, endTimeAm, Me.usr_id)
    ...
    Private Sub btnDelete_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnDelete.Click
        If Not Me.usr_id = 0 Then
            ...
            Dim oTime As New clsiCTimePlan(ModId)
            Dim s As String
            s = oTime.DeleteCode(SelectedDate, Me.usr_id)
            Response.Write("<SCRIPT LANGUAGE=javaScript>window.opener.location.href='" & strParentUrl & "'; this.close();</script>")
        End If
    End Sub
