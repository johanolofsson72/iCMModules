Module Constants
    ...
    ' Calendar  
    Public Const TIMESPAN_BG_COLOR = "#E0DFE3"                  ' Gray
    Public Const TIMESPAN_BG_COLOR2 = "#ffffff"                  ' Gray
    Public Const TIMESPAN_TEXT_COLOR = "#000000"                ' Black
    Public Const TIMESPAN_HEADER_COLOR = "silver"               ' Silver
    Public Const TIMESPAN_TEXT_FAMILY = "verdana,arial"
    Public Const TIMESPAN_HOUR_WIDTH = "37px"
    Public Const TIMESPAN_HALFHOUR_WIDTH = "25px"
    Public Const CALENDAR_HEADER_COLOR = "#E0DFE3"              ' Gray
    Public Const CALENDAR_HEADER_COLOR_DARK = "Silver"          ' Silver

    Public Const CALENDAR_HEADER_BORDER_DARK = "gray"           ' DarkGray
    Public Const CALENDAR_HEADER_BORDER_LIGHT = "#FFFFFF"       ' White

    Public Const CALENDAR_BACK_COLOR = "#FFF4BC"                ' Yellow
    Public Const CALENDAR_BORDER_HOUR_COLOR = "#EAD098"         ' DarkRed
    Public Const CALENDAR_BORDER_HALF_COLOR = "#F3E4B1"         ' LightRed
    Public Const CALENDAR_APPOINTMENT_COLOR = "#FFFFFF"         ' White
    Public Const CALENDAR_NOAPPOINTMENT_OVERCOLOR = "#FFFFD5"   ' White
    Public Const CALENDAR_PRE_APPOINTMENT_COLOR = "#0000FF"     ' Blue
    Public Const CALENDAR_APPOINTMENT_BORDER_COLOR = "#000000"  ' Black
    Public Const CALENDAR_CALCULATE_CONSTANT = 87               ' Used to calculate width of calendar columns
