...
Public Class clsTemplate003
    ...
    Public Function GetTemplate() As DataSet
        Try
            Dim ds As New DataSet
            If Not oDO.GetDataSet("tem_template003", "sit_id = " & oSite.SiteId & " AND pag_id = " & Me.PagId & " AND mod_id = " & Me.ModId & " AND tem_hidden = 0 AND tem_deleted = 0", "", "", ED, EC, ds) Then
    ...
    Public Function UpdateTemplate(ByVal ToolTip1 As String, ByVal ToolTip2 As String, ByVal ToolTip3 As String, ByVal ToolTip4 As String, ByVal ToolTip5 As String, ByVal ToolTip6 As String, ByVal ToolTip7 As String, ByVal ToolTip8 As String, ByVal ToolTip9 As String) As Boolean
        Try
            ...
            If Not Exists Then
                ds = New DataSet
                If Not oDO.GetEmptyDataSet("tem_template003", "", ED, EC, ds) Then
                    Return False
                End If
