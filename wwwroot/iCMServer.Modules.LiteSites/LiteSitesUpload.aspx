<%@ Page Language="vb" AutoEventWireup="false" Codebehind="LiteSitesUpload.aspx.vb" Inherits="iConsulting.iCMServer.Modules.LiteSites.LiteSitesUpload" %>
<HTML>
	<HEAD>
										...
										<tr valign="top">
											...
											<td>
												<asp:TextBox id="NameField" cssclass="NormalTextBox" width="353" Columns="28" maxlength="150"
													runat="server" Wrap="False"  Visible="false"/>
											</td>
