...
#Region " Web Form Designer Generated Code "
    ...
    Protected WithEvents btnDir As System.Web.UI.WebControls.Button
    Protected WithEvents txtDir As System.Web.UI.WebControls.TextBox
    ...
    Protected BoundedDirectory As String
...
#End Region
    ...
    Private Sub BindData()
        ...
        If Not Page.IsPostBack Then
            ...
            ' Read the BoundedDirectory from ModuleConfiguration.Iconfile....
            Try
                BoundedDirectory = CType(ModuleConfiguration.IconFile, String)
            Catch ex As Exception
                BoundedDirectory = ""
            End Try
            txtDir.Text = BoundedDirectory
            btnDir.Text = "Save"
            Session("BoundedDirectory" & ModId) = BoundedDirectory
            If Not HasEditAuth Then
    ...
    Private Sub btnDir_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnDir.Click
        Dim oDoc As New clsDocuments
        If Not oDoc.UpdateModuleDirectory(PagId, ModId, txtDir.Text) Then
