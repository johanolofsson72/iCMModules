<%@ Page Language="vb" AutoEventWireup="false" Codebehind="BBEdit.aspx.vb" Inherits="iConsulting.iCMServer.Modules.BB.BBEdit"%>
						...
						<table cellSpacing="0" cellPadding="0" width="680" border="0" style="BORDER-RIGHT: gray 1px solid; BORDER-TOP: gray 1px solid; BORDER-LEFT: gray 1px solid; BORDER-BOTTOM: gray 1px solid">
							...
							<TR>
								...
								<TD vAlign="top">
									...
									<P>
										<INPUT id="Browse1" style="WIDTH: 284px; HEIGHT: 22px" type="file" size="28" name="FileUpload"
											runat="server">
									</P>
								</TD>
							</TR>
