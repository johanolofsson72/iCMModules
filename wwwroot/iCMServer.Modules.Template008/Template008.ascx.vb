...
Public Class Template008 : Inherits clsSiteModuleControl
...
#Region " Web Form Designer Generated Code "
    ...
    Protected WithEvents TextLabel As System.Web.UI.WebControls.Label
...
#End Region
    ...
    Private Sub BindData()
        Try
            ...
            Dim oTemplate008 As New clsTemplate008(ModuleId, oSite.ActivePage.PageId, clsSiteSecurity.HasEditPermissions(ModuleId))
            ...
            If ds.Tables.Count > 0 Then
                If ds.Tables(0).Rows.Count > 0 Then
                    ...
                    NavImage5.ToolTip = ds.Tables(0).Rows(0)("tem_tooltip5")
                    ...
                    NavImage1.ImageUrl = "BinaryFileCache/" & "Template008_1__" & ModuleId.ToString
                    NavImage2.ImageUrl = "BinaryFileCache/" & "Template008_2__" & ModuleId.ToString
                    NavImage3.ImageUrl = "BinaryFileCache/" & "Template008_3__" & ModuleId.ToString
                    NavImage4.ImageUrl = "BinaryFileCache/" & "Template008_4__" & ModuleId.ToString
                    NavImage5.ImageUrl = "BinaryFileCache/" & "Template008_5__" & ModuleId.ToString
                    NavImage6.ImageUrl = "BinaryFileCache/" & "Template008_6__" & ModuleId.ToString
                    NavImage7.ImageUrl = "BinaryFileCache/" & "Template008_7__" & ModuleId.ToString
                    NavImage8.ImageUrl = "BinaryFileCache/" & "Template008_8__" & ModuleId.ToString
                    NavImage9.ImageUrl = "BinaryFileCache/" & "Template008_9__" & ModuleId.ToString
                    TextLabel.Text = ds.Tables(0).Rows(0)("tem_text")
                    If CType(ds.Tables(0).Rows(0)("tem_popupon"), Integer) = 1 Then
                        If System.IO.File.Exists(Server.MapPath("Desktop/Modules/Template008/BinaryFileCache/" & "Template008_10__" & ModuleId.ToString)) Then
                            Dim Bmp As New System.Drawing.Bitmap(Server.MapPath("Desktop/Modules/Template008/BinaryFileCache/" & "Template008_10__" & ModuleId.ToString))
                            Response.Write("<script language=""javascript"">window.open('" & "Desktop/Modules/Template008/BinaryFileCache/" & "Template008_11__" & ModuleId.ToString & "','','toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=yes, width=" & Bmp.Width & ", height=" & Bmp.Height & "')</script>")
    ...
    Private Sub BindNavigation()
        Try
            Dim oSite As clsSiteSettings = CType(HttpContext.Current.Items("SiteSettings"), clsSiteSettings)
            Dim oTemplate008 As New clsTemplate008(ModuleId, oSite.ActivePage.PageId, clsSiteSecurity.HasEditPermissions(ModuleId))
            Dim ds As DataSet = oTemplate008.GetHeadMenuItem
    ...
    Private Sub ShowNavigation(ByVal Field As Integer, ByVal Title As String, ByVal Link As String)
        Try
            Select Case Field
                ...
                Case 5
                    Navigator5 = Link
                    NavLabel5.Text = "[" & Title & "]"
                    NavPanel5.Visible = True
                    NavImage5.Visible = True
                Case 6
                    Navigator6 = Link
