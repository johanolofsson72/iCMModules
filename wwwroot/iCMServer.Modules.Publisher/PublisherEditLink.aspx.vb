        ...
        If Not Page.IsPostBack Then
            ...
            For Each drd In dsd.Tables(0).Rows
                If drd("pag_deleted") = False Then
                    ddUrl.Items.Add(New System.Web.UI.WebControls.ListItem(drd("pag_name"), Left(Request.Url.AbsoluteUri, InStr(Request.Url.AbsoluteUri, "Desktop/Modules/Publisher/PublisherEditLink.aspx") - 1) & "iCM.aspx?PageId=" & drd("pag_id")))
                End If
            Next
        End If
    End Sub
