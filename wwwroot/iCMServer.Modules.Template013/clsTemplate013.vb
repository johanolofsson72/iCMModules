...
Public Class clsTemplate013
    ...
    Public Function GetTemplate() As DataSet
        Try
            ...
            If Not oDO.GetDataSet("tem_template013", "sit_id = " & oSite.SiteId & " AND pag_id = " & Me.PagId & " AND mod_id = " & Me.ModId & " AND tem_hidden = 0 AND tem_deleted = 0", "", "", ED, EC, ds) Then
    ...
    Public Function UpdateTemplate(ByVal SmtpServer As String, ByVal SmtpMail As String, ByVal SubjectPrefix As String, ByVal Users As String, ByVal Courses As String) As Boolean
        Try
            ...
            If Not Exists Then
                ds = New DataSet
                If Not oDO.GetEmptyDataSet("tem_template013", "", ED, EC, ds) Then
                    Return False
                End If
