...
#Region " Web Form Designer Generated Code "
    ...
    Protected WithEvents txtCourses As System.Web.UI.WebControls.TextBox
    Protected WithEvents lblCourses As System.Web.UI.WebControls.Label
...
#End Region
    ...
    Private Sub BindData()
        Try
            ...
            Dim oTemplate013 As New clsTemplate013(ModId, oSite.ActivePage.PageId, clsSiteSecurity.HasEditPermissions(ModId))
            ...
            If ds.Tables.Count > 0 Then
                If ds.Tables(0).Rows.Count > 0 Then
                    ...
                    txtCourses.Text = ds.Tables(0).Rows(0)("tem_cources")
                End If
            End If

            HeaderText.Text = Server.HtmlDecode(oLanguageText.Find(al, "template013_header"))
            lblSmtp.Text = Server.HtmlDecode(oLanguageText.Find(al, "template013_smtp"))
            lblMail.Text = Server.HtmlDecode(oLanguageText.Find(al, "template013_default"))
            lblPrefix.Text = Server.HtmlDecode(oLanguageText.Find(al, "template013_prefix"))
            lblUsers.Text = Server.HtmlDecode(oLanguageText.Find(al, "template013_users"))
            lblNotice.Text = Server.HtmlDecode(oLanguageText.Find(al, "template013_notice"))
            lblCourses.Text = Server.HtmlDecode(oLanguageText.Find(al, "template013_cource"))
            btnOk.Text = Server.HtmlDecode(oLanguageText.Find(al, "template013_ok"))
            btnCancel.Text = Server.HtmlDecode(oLanguageText.Find(al, "template013_cancel"))
    ...
    Private Sub btnOk_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnOk.Click
        Try
            Dim oSite As clsSiteSettings = CType(HttpContext.Current.Items("SiteSettings"), clsSiteSettings)
            Dim oTemplate013 As New clsTemplate013(ModId, oSite.ActivePage.PageId, clsSiteSecurity.HasEditPermissions(ModId))
            oTemplate013.UpdateTemplate(txtSmtp.Text, txtMail.Text, txtPrefix.Text, txtUsers.Text, txtCourses.Text)
