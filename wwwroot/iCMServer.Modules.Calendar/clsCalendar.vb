...
#Region " Public Render Functions "
    ...
    Public Function GetCalendarField(ByVal SelectedDate As Date, ByVal DoTimeSpan As Boolean, ByVal TotalColumns As Integer, ByVal View As String) As DataSet
...
#Region " Private Render Functions "
    ...
    Private Function BuildTempTables(ByVal SelectedDate As Date, ByVal dsAppointments As DataSet, ByVal dsTimeSpan As DataSet) As DataSet
        ...
        For Each drAppointment In dsAppointments.Tables(0).Rows
            ...
            tmpText = CType(drAppointment("cal_text"), String)                                    ' Testtext
                    ...
                    For Each drTmp In dtTmp.Rows
                        ...
                        If drTmp("cal_id") = "0" Then
                            If CType(drTmp("time"), Date) = tmpStartTime And CType(drTmp("time"), Date) = tmpEndTime Then
                                ...
                                drTmp("cal_text") = tmpSubject & vbCrLf & tmpText
            ...
            If Not tmpInserted Then
                ...
                For Each drTS In dsTimeSpan.Tables("Default").Rows
                    ...
                    If CType(drTS("time"), Date) = tmpStartTime And CType(drTS("time"), Date) = tmpEndTime Then
                        ...
                        drIns("cal_text") = tmpSubject & vbCrLf & tmpText
    ...
    Private Function GetAppointmentRowHourString(ByVal SelectedDate As Date, ByVal Time As String, ByVal isFirst As Boolean, ByVal cal_id As String, ByVal cal_subject As String, ByVal cal_text As String, ByVal isStart As String, ByVal isEnd As String, ByVal isSpanStart As String, ByVal isSpanIn As String, ByVal isSpanEnd As String, ByVal iWidth As Integer, ByVal Label As String) As String
        Dim sTemp As String
        ...
        Else
            ...
            sTemp += DrawAppointmentRow(cal_id, cal_subject, cal_text, isStart, isEnd, isSpanStart, isSpanIn, isSpanEnd, iWidth, Label)
        End If

        Return sTemp
    End Function

    Private Function GetAppointmentRowDelimeterString(ByVal SelectedDate As Date, ByVal Time As String, ByVal isFirst As Boolean, ByVal cal_id As String, ByVal cal_subject As String, ByVal cal_text As String, ByVal isStart As String, ByVal isEnd As String, ByVal isSpanStart As String, ByVal isSpanIn As String, ByVal isSpanEnd As String, ByVal iWidth As Integer, ByVal Label As String) As String
        Dim sTemp As String
    ...
    Private Function CalculateTooltipString(ByVal Subject As String, ByVal Text As String) As String
        Try
            Return Subject & vbCrLf & Text
        Catch ex As Exception
            Return "&nbsp;"
        End Try
    End Function

    Private Function DrawAppointmentRow(ByVal cal_id As String, ByVal cal_subject As String, ByVal cal_text As String, ByVal isStart As String, ByVal isEnd As String, ByVal isSpanStart As String, ByVal isSpanIn As String, ByVal isSpanEnd As String, ByVal iWidth As Integer, ByVal Label As String) As String
        Dim sTemp As String
        'OVERFLOW: hidden;
        sTemp += "<tr height=20>"
        If isSpanStart = "1" Then
            ...
            sTemp += "  <td nowrap " & IIf(Me.m_IsAuthorized, " onclick=""OPENEDIT(" & cal_id & ");""", "") & " bgcolor=" & Label & " style='" & IIf(Me.m_IsAuthorized, "cursor:hand;", "") & " OVERFLOW: hidden;" & IIf(isStart = "1", "BORDER-TOP: " & CALENDAR_APPOINTMENT_BORDER_COLOR & " 1px solid;", "") & IIf(isEnd = "1", "BORDER-BOTTOM: " & CALENDAR_APPOINTMENT_BORDER_COLOR & " 1px solid;", "") & " BORDER-LEFT: " & CALENDAR_APPOINTMENT_BORDER_COLOR & " 1px solid'>"
        ElseIf isSpanIn = "1" Then
            ...
            sTemp += "  <td nowrap " & IIf(Me.m_IsAuthorized, " onclick=""OPENEDIT(" & cal_id & ");""", "") & " bgcolor=" & Label & " style='" & IIf(Me.m_IsAuthorized, "cursor:hand;", "") & " OVERFLOW: hidden;" & IIf(isStart = "1", "BORDER-TOP: " & CALENDAR_APPOINTMENT_BORDER_COLOR & " 1px solid;", "") & IIf(isEnd = "1", "BORDER-BOTTOM: " & CALENDAR_APPOINTMENT_BORDER_COLOR & " 1px solid;", "") & "'>"
        ElseIf isSpanEnd = "1" Then
            ' This is a spanned appointment and is the last one...
            sTemp += "  <td bgcolor=" & Label & " style='" & IIf(isStart = "1", "BORDER-TOP: " & CALENDAR_APPOINTMENT_BORDER_COLOR & " 1px solid;", "") & IIf(isEnd = "1", "BORDER-BOTTOM: " & CALENDAR_APPOINTMENT_BORDER_COLOR & " 1px solid;", "") & " WIDTH: 1px'><font style='FONT-WEIGHT: normal; FONT-SIZE: x-small; FONT-FAMILY: Verdana'>&nbsp;</font></td>"
            sTemp += "  <td nowrap " & IIf(Me.m_IsAuthorized, " onclick=""OPENEDIT(" & cal_id & ");""", "") & " bgcolor=" & Label & " style='" & IIf(Me.m_IsAuthorized, "cursor:hand;", "") & " OVERFLOW: hidden;BORDER-RIGHT: " & CALENDAR_APPOINTMENT_BORDER_COLOR & " 1px solid; " & IIf(isStart = "1", "BORDER-TOP: " & CALENDAR_APPOINTMENT_BORDER_COLOR & " 1px solid;", "") & IIf(isEnd = "1", "BORDER-BOTTOM: " & CALENDAR_APPOINTMENT_BORDER_COLOR & " 1px solid;", "") & "'>"
        Else
            ...
            sTemp += "  <td nowrap title=""" & cal_text & """ " & IIf(Me.m_IsAuthorized, " onclick=""OPENEDIT(" & cal_id & ");""", "") & " bgcolor=" & Label & " style='" & IIf(Me.m_IsAuthorized, "cursor:hand;", "") & " OVERFLOW: hidden;BORDER-RIGHT: " & CALENDAR_APPOINTMENT_BORDER_COLOR & " 1px solid; " & IIf(isStart = "1", "BORDER-TOP: " & CALENDAR_APPOINTMENT_BORDER_COLOR & " 1px solid;", "") & IIf(isEnd = "1", "BORDER-BOTTOM: " & CALENDAR_APPOINTMENT_BORDER_COLOR & " 1px solid;", "") & " BORDER-LEFT: " & CALENDAR_APPOINTMENT_BORDER_COLOR & " 1px solid'>"
        End If
