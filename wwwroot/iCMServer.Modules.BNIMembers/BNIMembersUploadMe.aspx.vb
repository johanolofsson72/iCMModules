Public Class BNIMembersUploadMe
...
#End Region
    ...
    Private Sub BindData()
        ...
        lblTitle.Text = Server.HtmlDecode(oLang.Find(al, "bnimember_metitle"))
        btnSave.Text = Server.HtmlDecode(oLang.Find(al, "bnimember_mesave"))
        btnCancel.Text = Server.HtmlDecode(oLang.Find(al, "bnimember_mecancel"))
        btnDelete.Text = Server.HtmlDecode(oLang.Find(al, "bnimember_medelete"))
    ...
    Private Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        If FileUpload.PostedFile.ContentLength < 1230000 Then
            ...
            oBNI.UpdateMe(PagId, ModId, BmeId, content, contentType, length)
        End If
    ...
    Private Sub btnDelete_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnDelete.Click
        Dim oBNI As New clsBNIMembers
        If Not oBNI.DeletePicture(PagId, ModId, BmeId, "Me") Then
