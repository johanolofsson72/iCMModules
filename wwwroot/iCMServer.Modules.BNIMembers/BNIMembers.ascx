...
<div id="Minimizer" runat="server">
	<table id="Table1" style="WIDTH: 584px; HEIGHT: 480px" align="left" height="480" width="584"
		...
		<tr>
			...
			<td vAlign="top" height="62"><asp:textbox id="txtBoxSearch" style="BORDER-RIGHT: #f3f3cd 1pt solid; BORDER-TOP: #f3f3cd 1pt solid; FONT-SIZE: xx-small; OVERFLOW-Y: auto; BORDER-LEFT: #f3f3cd 1pt solid; COLOR: dimgray; BORDER-BOTTOM: #f3f3cd 1pt solid; FONT-FAMILY: Verdana; BACKGROUND-COLOR: transparent"
