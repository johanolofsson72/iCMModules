...
Public Class NorskFilmWizardEdit
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not Page.IsPostBack Then
            ...
            ddlWeek.SelectedIndex = selectedWeek - 1
    ...
    Private Sub BindData()
        ...
        '    Dim oTemplate006 As New clsNorskFilmWizard(ModID, oSite.ActivePage.PageId, clsSiteSecurity.HasEditPermissions(ModID))
    ...
    Private Sub Save_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Save.Click
        'Try
        '    Dim oSite As clsSiteSettings = CType(HttpContext.Current.Items("SiteSettings"), clsSiteSettings)
        '    Dim oBB As New clsNorskFilmWizard(ModID, oSite.ActivePage.PageId, clsSiteSecurity.HasEditPermissions(ModID))
