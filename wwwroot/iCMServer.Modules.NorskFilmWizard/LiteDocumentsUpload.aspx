<%@ Page Language="vb" AutoEventWireup="false" Codebehind="LiteDocumentsUpload.aspx.vb" Inherits="iConsulting.iCMServer.Modules.NorskFilmWizard.LiteDocumentsUpload" %>
<HTML>
	<HEAD>
								...
								<td>
									...
									<table width="726" cellspacing="0" cellpadding="0" border="0">
										<tr valign="top">
											...
											<td>
												<asp:TextBox id="txtTitle" cssclass="NormalTextBox" width="353" Columns="28" maxlength="150"
													runat="server" />
											</td>
										...
										<tr valign="top">
											...
											<td>
												...
												<br>
												<input type="file" id="FileUpload" width="300" style="WIDTH:344px;FONT-FAMILY:verdana;HEIGHT:22px"
													runat="server" NAME="FileUpload" size="38">
											</td>
										</tr>
										<tr>
											<td colspan="3">
