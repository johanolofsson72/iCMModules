					...
					<TD valign="top" width="400">
						...
						<fieldset style = "display:none" id ="map_props" >
							...
							<DIV id="area_props">
								...
								<BUTTON class="Button" onclick="var t = UpdateAreaPropsDlg()" type="button" id="area_update_button" disabled>
									<SCRIPT>localization.showText('Update');</SCRIPT>
								</BUTTON><button class="Button" onclick="var t = RemoveAreaDlg()" type="button" id="area_remove_button" disabled>
									<script>localization.showText('Remove');</script>
								</button><button class="Button" onclick="var t = RemoveAreaDlg(true)" type="button" id="area_remove_all_button">
									<script>localization.showText('RemoveAll');</script>
								</button>
							</DIV>
						</fieldset>
								</td>
