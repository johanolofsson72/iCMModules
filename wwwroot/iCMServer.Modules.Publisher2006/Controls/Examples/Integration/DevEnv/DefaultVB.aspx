<%@ Page Language="vb" CodeBehind="DefaultVB.aspx.vb" AutoEventWireup="false" Inherits="Telerik.IntegrationExamplesVBNET.Devenv.DefaultVB" %>
...
<html>
	...
	<body class="body">
		<form id="Form1" method="post" runat="server">
			...
			<!-- docking manager end -->
			<telerik:Header XhtmlCompliant="false" runat="server" ID="Header1" NavigationLanguage="VB"></telerik:Header>
			<!-- ////////////////////////////// VS.Net IDE Start ////////////////////////////// -->
