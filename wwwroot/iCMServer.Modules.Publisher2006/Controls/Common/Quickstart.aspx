...
<div id="tab1" class="text">
	...
	<ol>
		...
		<li>Right click it and open Customize Toolbox (called Add/Remove Items in v.1.1).</li>
		<li>Click the .NET Framework Components tab.</li>
		<li>Click the Browse button.</li>
		<li>Browse to the location where <%= ProductInfo.RadControlName %>.dll file resides and open it. By default, it must be in your Program Files\telerik\r.a.d.<%= ProductInfo.ControlName %><%= ProductInfo.Version %>\NET1\bin folder.</li>
...
<div id="tab2" class="text" style="display:none">
	...
	<ul>
		<li>Drag the r.a.d.<strong><%= ProductInfo.ControlName %></strong> icon from the toolbox and drop it in your Web form / Web user control. Visual Studio will automatically copy the <%= ProductInfo.RadControlName %>.dll to the .\bin folder of your Web application and will create the respective Reference. </li>
	</ul>
...
<div id="tab3" class="text" style="display:none">
	...
	<ol>
		<li>Copy the <%= ProductInfo.RadControlName %>.dll from the .\bin folder to the .\bin folder of your web-application. </li>
	...
	<ul>
		...
		<li>Add the following tag in the beginning of your ASP.NET page:
			...
			<span style="background:yellow 0% 50%;moz-background-clip:initial;moz-background-inline-policy:initial;moz-background-origin:initial">
				&lt;%@ Register TagPrefix="rad<%= ProductInfo.FirstLetter %>" Namespace="Telerik.WebControls" Assembly="<%= ProductInfo.RadControlName %>"%&gt;<br/>
			</span></li>
