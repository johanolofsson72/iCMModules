...
<div id="tab1" class="text">
	...
	<ol>
		...
		<li>Browse to the location where <%= ProductInfo.RadControlName %>.dll file resides and open it. By default, it must be in your Program Files\telerik\r.a.d.<%= ProductInfo.ControlName %><%= ProductInfo.Version %>\bin folder.</li>
